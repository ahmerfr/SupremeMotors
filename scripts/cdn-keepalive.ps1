...
$shards = @(
    ...
    @{ name = 'gc';  min = 232420; max = 300000; pool = 60; timeout = 20; scope = 'all' },
    @{ name = 'gc2'; min = 300000; max = 345000; pool = 60; timeout = 20; scope = 'all' },
    @{ name = 'gd';  min = 345000; max = 385000; pool = 60; timeout = 20; scope = 'all' },
    @{ name = 'gd2'; min = 385000; max = 453376; pool = 60; timeout = 20; scope = 'all' }
)
