...
$shards = @(
    ...
    @{ name = 'gc';  min = 232420; max = 259000; pool = 60; timeout = 20; scope = 'all' },
    @{ name = 'gf';  min = 259000; max = 270000; pool = 60; timeout = 20; scope = 'all' },
    @{ name = 'gc3'; min = 270000; max = 289000; pool = 60; timeout = 20; scope = 'all' },
    @{ name = 'gg';  min = 289000; max = 300000; pool = 60; timeout = 20; scope = 'all' },
    @{ name = 'gc2'; min = 300000; max = 324000; pool = 120; timeout = 20; scope = 'all' },
    @{ name = 'gc4'; min = 324000; max = 345000; pool = 120; timeout = 20; scope = 'all' },
    @{ name = 'gd';  min = 345000; max = 368000; pool = 120; timeout = 20; scope = 'all' },
    @{ name = 'gd3'; min = 368000; max = 385000; pool = 120; timeout = 20; scope = 'all' },
    @{ name = 'gd2'; min = 385000; max = 406000; pool = 60; timeout = 20; scope = 'all' },
    @{ name = 'ge';  min = 406000; max = 420000; pool = 60; timeout = 20; scope = 'all' },
    @{ name = 'gd4'; min = 420000; max = 453376; pool = 120; timeout = 20; scope = 'all' }
)
