...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="https://fonts.bunny.net/css?family=instrument-sans:400,500,600|manrope:400,500,600,700,800|archivo:400,500,600,700|chivo-mono:400,500,700" rel="stylesheet" />
