...
const showPrice = computed(() => p.price > 0 && ['tcv', 'suprememotors', 'electricvehicles'].some((s) => (p.website || '').includes(s)));
                    ...
                    <div style="position: relative; overflow: hidden; min-width: 0; border-radius: 24px; background: linear-gradient(150deg, #12284a, #0b1e3b 55%, #081730); padding: 30px 32px">
                        ...
                        <div style="position: relative">
                            ...
                            <div v-if="showPrice">
                                ...
                                <div style="font-size: 12.5px; font-weight: 600; color: #8ea0bc; margin-top: 3px">FOB price — ask for a landed quote to your port</div>
                            </div>
                            <div v-else>
