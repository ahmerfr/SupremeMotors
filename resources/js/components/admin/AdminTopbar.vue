...
<template>
    <header class="sticky top-0 z-30 border-b border-zinc-200 bg-[#fafafa]/90 backdrop-blur-lg dark:border-white/[0.07] dark:bg-[#101010]/90">
        <div class="flex h-[60px] items-center justify-between gap-4 px-6 lg:px-10">
            ...
            <div class="flex shrink-0 items-center gap-3">
                <span class="hidden text-sm font-medium text-zinc-400 md:block dark:text-zinc-500">{{ today }}</span>
                <a
                    href="/"
                    target="_blank"
                    class="flex h-8 items-center gap-1 rounded-lg px-3 text-sm font-medium text-zinc-500 transition-colors duration-300 hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-400 dark:hover:bg-white/[0.06] dark:hover:text-white"
                >
